...
CREATE INDEX IF NOT EXISTS discount_codes_seller_idx ON discount_codes (seller_id);
...
CREATE INDEX IF NOT EXISTS returns_seller_idx ON returns (seller_id);
CREATE INDEX IF NOT EXISTS returns_buyer_idx  ON returns (buyer_id);
...
CREATE INDEX IF NOT EXISTS shipping_rates_seller_idx ON shipping_rates (seller_id);
