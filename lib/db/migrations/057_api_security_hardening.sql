-- Reassert the API security tables under a unique migration filename.
-- This intentionally duplicates the idempotent 055 migration so databases
-- affected by historical 055 filename collisions are repaired automatically.
