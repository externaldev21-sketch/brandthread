# Migrating web UI to Brandthread Woven

Read `artifacts/brandthread-woven/docs/AGENTS.md` and
`artifacts/brandthread-woven/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/brandthread-woven/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/brandthread-woven/lib/utils`
- `@/hooks/use-toast` → `@workspace/brandthread-woven/hooks/use-toast`
