# Brandthread Woven design system
...
workspace package (`@workspace/brandthread-woven`): other artifacts depend
...
- `src/components/` — the source-backed Woven component families. Public exports
  are intentionally limited to the implemented inventory.
- `docs/references/component-inventory.md` and `docs/references/components/` —
  retained source evidence, ranked rollout chunks, and family build contracts.
...
"./styles.css":   "./src/index.css",
    "./components/<implemented-family>": "./src/components/<implemented-family>.tsx",
"./lib/*":        "./src/lib/*.tsx",
"./hooks/*":      "./src/hooks/*.tsx"
```
...
`@workspace/brandthread-woven/components/...`. Never use a `@/` alias inside
...
Every user-facing web component under `src/components/` must have a family
...
for `@workspace/brandthread-woven` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/brandthread-woven` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/brandthread-woven/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/brandthread-woven/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/brandthread-woven/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/brandthread-woven/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/brandthread-woven/docs/migrating-expo.md`
