# Consuming Brandthread Woven in Expo apps

Read `artifacts/brandthread-woven/docs/AGENTS.md` first. React Native does
...
`artifacts/brandthread-woven/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/brandthread-woven/tokens";
...
```tsx
import { nativeTheme } from "@workspace/brandthread-woven/lib/native-theme";
import { useColors } from "@workspace/brandthread-woven/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/brandthread-woven/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/brandthread-woven/components/native/badge";
import { Button } from "@workspace/brandthread-woven/components/native/button";
import { Card } from "@workspace/brandthread-woven/components/native/card";
```
...
Import and render
`@workspace/brandthread-woven/components/native/button`, then run Expo
