...
const SONGS = [
  ...
  { id: '2',  title: 'Please Please Please',   artist: 'Sabrina Carpenter',     duration: '3:06', color: '#00C853' },
  ...
  { id: '8',  title: 'Die With A Smile',       artist: 'Lady Gaga & Bruno Mars',duration: '4:11', color: '#00C853' },
  ...
  { id: '14', title: 'Lose Control',           artist: 'Teddy Swims',           duration: '3:44', color: '#00C853' },
  ...
  { id: '17', title: 'Disease',                artist: 'Lady Gaga',             duration: '4:05', color: '#0F3822' },
...
const TEXT_COLORS = ['#FFFFFF', '#000000', '#39FF88', '#EC4899', '#B98A2E', '#4C9A5E', '#4A6FA5', '#EF4444'];
  ...
  if (posted) {
    return (
      <View style={{ flex: 1, backgroundColor: '#121110', alignItems: 'center', justifyContent: 'center' }}>
        <LinearGradient colors={['#0F3822', '#00C853']} style={s.postedCircle}>
    ...
    <View style={{ flex: 1, backgroundColor: '#000' }}>
            ...
            <View style={s.topRight}>
              {[
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={0.75}
                >
                  <BlurView intensity={40} tint="dark" style={[s.topBtnBlur, activePanel === panel && { backgroundColor: '#39FF8860' }]}>
      ...
      <View style={[s.bottomBar, { paddingBottom: Math.max(insets.bottom, 16), backgroundColor: activePanel === 'none' ? '#000' : 'transparent' }]}>
        ...
        <TouchableOpacity onPress={handlePost} activeOpacity={0.85}>
          <LinearGradient colors={['#0F3822', '#00C853']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={s.postBtn}>
            ...
            {activePanel === 'text' && (
              <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
                ...
                <View style={s.sizeRow}>
                  {TEXT_SIZES.map(sz => (
                    <TouchableOpacity
                      ...
                      style={[s.sizeBtn, { backgroundColor: textSize === sz ? '#00C853' : (isDark ? '#1D1A15' : '#E8E1CF'), borderColor: isDark ? '#2A261E' : '#DBD3C0' }]}
                    >
                      <Text style={{ fontSize: 12, fontFamily: 'Inter_600SemiBold', color: textSize === sz ? '#FFF' : (isDark ? '#39FF88' : '#00C853') }}>
                ...
                <TouchableOpacity onPress={addText} style={s.doneBtn} activeOpacity={0.85}>
                  <LinearGradient colors={['#0F3822', '#00C853']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={s.doneBtnGrad}>
                  ...
                  renderItem={({ item }) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {chosen
                          ? <Feather name="check-circle" size={20} color="#39FF88" />
...
const s = StyleSheet.create({
  ...
  colorSwatchActive: { borderWidth: 3, borderColor: '#39FF88', transform: [{ scale: 1.15 }] },
