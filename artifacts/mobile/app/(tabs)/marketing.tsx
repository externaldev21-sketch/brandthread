...
export default function MarketingScreen() {
  ...
  return (
    ...
    >
      ...
      <View style={[styles.section, { backgroundColor: colors.card, borderColor: colors.border }]}>
        {CAMPAIGNS.map((c, i) => (
          <View key={c.id} style={[styles.campaignRow, i > 0 && { borderTopWidth: 1, borderTopColor: colors.border }]}>
            <View style={[styles.campaignIcon, { backgroundColor: c.type === 'Email' ? 'rgba(59,130,246,0.13)' : c.type === 'SMS' ? 'rgba(34,211,238,0.13)' : 'rgba(139,92,246,0.13)' }]}>
              <Feather
      ...
      <View style={[styles.section, { backgroundColor: colors.card, borderColor: colors.border }]}>
        {DISCOUNTS.map((d, i) => (
          <View key={d.code} style={[styles.discountRow, i > 0 && { borderTopWidth: 1, borderTopColor: colors.border }]}>
            <View style={[styles.codeWrap, { backgroundColor: 'rgba(139,92,246,0.13)' }]}>
      ...
      <View style={[styles.referralCard, { backgroundColor: '#12121F', borderColor: 'rgba(139,92,246,0.26)' }]}>
