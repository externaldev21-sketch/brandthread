...
export default function MarketingScreen() {
  ...
  return (
    ...
    >
      ...
      <View style={[styles.section, { backgroundColor: colors.card, borderColor: colors.border }]}>
        {CAMPAIGNS.map((c, i) => (
          <View key={c.id} style={[styles.campaignRow, i > 0 && { borderTopWidth: 1, borderTopColor: colors.border }]}>
            <View style={[styles.campaignIcon, { backgroundColor: c.type === 'Email' ? '#3B82F622' : c.type === 'SMS' ? '#22C55E22' : '#C9A96E22' }]}>
              <Feather
      ...
      <View style={[styles.section, { backgroundColor: colors.card, borderColor: colors.border }]}>
        {DISCOUNTS.map((d, i) => (
          <View key={d.code} style={[styles.discountRow, i > 0 && { borderTopWidth: 1, borderTopColor: colors.border }]}>
            <View style={[styles.codeWrap, { backgroundColor: '#C9A96E22' }]}>
      ...
      <View style={[styles.referralCard, { backgroundColor: '#1A1500', borderColor: '#C9A96E44' }]}>
