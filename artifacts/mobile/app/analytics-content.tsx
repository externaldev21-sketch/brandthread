...
const createStyles = (colors: ReturnType<typeof useColors>) => {
  ...
  tileChange:{ fontSize: FS.xs, fontFamily: FONT.medium },
  ...
  postTypeText:{ fontSize: FS.xs, fontFamily: FONT.bold, color: MUTED },
  ...
  retentionX:{ fontSize: FS.xs, fontFamily: FONT.regular, color: SUBTLE },
  retentionLegend:{ flexDirection: 'row', gap: 12, marginTop: 10 },
  legendItem:{ flexDirection: 'row', alignItems: 'center', gap: 4 },
  legendDot:{ width: 8, height: 8, borderRadius: 4 },
  legendText:{ fontSize: FS.xs, fontFamily: FONT.regular, color: MUTED },
