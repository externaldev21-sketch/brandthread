...
import { View, Text, TouchableOpacity, StyleSheet, ScrollView, ActivityIndicator, Alert, Switch, Linking, TextInput } from 'react-native';
    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 60 }}>
        ...
        <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border, marginTop: 16 }]}>
          ...
          <Text style={[styles.explainerStep, { color: colors.mutedForeground }]}>
            1. Turn this on and connect (or reuse) your Shopify store.
          </Text>
          <Text style={[styles.explainerStep, { color: colors.mutedForeground }]}>
            2. Keep your fulfillment app (Tapstitch, Printful, Printify, …) installed and configured on that Shopify store, same as today.
          </Text>
          <Text style={[styles.explainerStep, { color: colors.mutedForeground }]}>
            3. When a Brandthread order for a linked product is paid, we create it in your Shopify store — your fulfillment app picks it up and ships it automatically, and tracking flows back here.
          </Text>
...
const styles = StyleSheet.create({
  ...
  explainerStep: { fontSize: 12, fontFamily: 'Inter_400Regular', lineHeight: 18, marginBottom: 8 },
  footNote: { fontSize: 11, fontFamily: 'Inter_400Regular', lineHeight: 16, marginTop: 4, fontStyle: 'italic' },
  disconnectBtn: { alignItems: 'center', paddingVertical: 16 },
