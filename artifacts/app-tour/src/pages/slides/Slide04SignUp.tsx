export default function Slide04SignUp() {
    ...
    <div className="w-screen h-screen overflow-hidden relative" style={{background:'#030503',fontFamily:"'Inter',sans-serif"}}>
      ...
      <div style={ph}>
        ...
        <div style={{flex:1,overflow:'hidden',padding:'1.5vh 3vh 0'}}>
          ...
          <div style={{fontSize:'2vh',fontWeight:800,color:'#FFF',letterSpacing:'-0.02em',marginBottom:'0.5vh'}}>CREATE YOUR</div>
          ...
          <div style={{background:'#00C853',borderRadius:'1.4vh',padding:'1.4vh',textAlign:'center',marginTop:'0.5vh'}}>
            <span style={{fontSize:'1.4vh',fontWeight:700,color:'#021208'}}>Create account</span>
          </div>
          <div style={{textAlign:'center',marginTop:'1.2vh'}}>
            <span style={{fontSize:'1vh',color:'rgba(255,255,255,0.25)'}}>By continuing, you agree to our Terms and Privacy Policy.</span>
          </div>
        </div>
      ...
      <div style={{position:'absolute',bottom:'3vh',left:'7vw',right:'7vw',display:'flex',justifyContent:'space-between'}}>
        <span style={{fontSize:'1.5vw',color:'rgba(255,255,255,0.3)',fontWeight:500,letterSpacing:'0.04em'}}>SIGN UP</span>
        <span style={{fontSize:'1.2vw',color:'rgba(255,255,255,0.18)'}}>04 / 19</span>
      </div>
    </div>
  );
}
